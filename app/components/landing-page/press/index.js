...
const images = [
  ...
  { file: 'fast-company-logo.svg', href: 'https://www.fastcompany.com/40513626/these-poverty-fighting-startups-are-slaying-silicon-valleys-sacred-cows' },
    ...
    <div className='images'>
      {images.map((img, i) => (
        <a href={img.href} key={i}>
          <img src={`/assets/imgs/${img.file}`} className='image' data-fit='contain' style={{ width: img.width }} />
        </a>
      ))}
    </div>
  </section>
